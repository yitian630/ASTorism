...
- (void)viewDidLoad
{
    ...
    [_toolbarBG release];
        ...
        //图片
        _picBG = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon228.png"]];//ShareImageBG.png
...
//    _atTipsLabel.backgroundColor = [UIColor redColor];
    _atTipsLabel.textColor = [UIColor colorWithRGB:0xd2d2d2];
    _atTipsLabel.textColor = [UIColor blackColor];
    _atTipsLabel.text = NSLocalizedString(@"TEXT_REMINE_VIEW", @"提醒微博好友查看");
    _atTipsLabel.font = [UIFont boldSystemFontOfSize:16];
...
{
    NSInteger count = 200 - [_textView.text length];
...
//    NSLog(@"sender:%@",sender);
//    NSArray *selectedClients = [NSArray arrayWithObject:@"1"];
